...
<div class="dash">
    ...
    <div class="dash-nav dash-nav-dark">
        <header>
            ...
            <a href="../../index.php" class="spur-logo"><i class="fas fa-bolt"></i> <span>SPower</span></a>
        </header>
        <nav class="dash-nav-list">
            ...
            <div class="dash-nav-dropdown">
                ...
                <div class="dash-nav-dropdown-menu">
                    <a href="history.php" class="dash-nav-dropdown-item">Transaksi</a>
                </div>
            </div>
            <!-- <div class="dash-nav-dropdown ">
                 <a href="#!" class="dash-nav-item dash-nav-dropdown-toggle">
                 ...
                 <div class="dash-nav-dropdown-menu">
                     ...
                     <div class="dash-nav-dropdown ">
                         ...
                         <div class="dash-nnotifikasiav-dropdown-menu">
            ...
            <div class="dash-nav-dropdown">
                ...
                <div class="dash-nav-dropdown-menu">
                    <a href="https://github.com/HackerThemes/spur-template" target="_blank" class="dash-nav-dropdown-item">Profile</a>
                </div>
            </div>
        </nav>
    </div>
